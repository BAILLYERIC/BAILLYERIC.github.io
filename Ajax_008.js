...
***************************************/
	...
	function LoadenvoiRequeteAjax(url,zone_tmp,couleur_fond) {
			AfficheInnerHTML("<table width='100%' height='100%' bgcolor='"+couleur_fond+"'><tr><td align='center' valign='middle'><img src='loading_009.gif' border='0'></td></tr></table>",zone_tmp)
